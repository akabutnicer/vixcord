...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="rounded-md w-1/2 sm:w-1/2 xl:w-1/3 login-container absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <div className="border-teal p-8 border-t-12 mb-6 rounded-lg shadow-lg bg-transparent">
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            class="block appearance-none w-full focus:!border-5 focus:!border-transparent hover:border-grey px-2 py-2 rounded shadow"
                        />
